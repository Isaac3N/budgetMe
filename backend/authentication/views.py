...
class RegisterView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        email_body = 'Hi '+user.username + \
            'Thank you for wanting to try BudgetMe. We promise you would not regret taking this massive step on your financial Journey.'\
            'Use the link below to verify your email and get Started \n' + absurl
